<template>
  <header v-once class='navbar navbar-expand-md navbar-dark navbar-overlap d-print-none'>
    <div class='container-xl'>
      <button class='navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbar-menu'>
        <span class='navbar-toggler-icon'></span>
      </button>
      <h1 class='navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3'>
        <router-link :to="{ name: 'home' }" class='wb-logo wb-logo-home'>
          webBudget
        </router-link>
      </h1>
      ...
      <div class='collapse navbar-collapse' id='navbar-menu'>
        <div class='d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center'>
          <ul class='navbar-nav'>
            <menu-section label='main-menu.base.financial'>
              <template #icon>
            ...
            <menu-section label='main-menu.base.investments'>
              <template #icon>
                <chart-area-icon />
              </template>
              <template #items>
            ...
            <menu-section label='main-menu.base.registration'>
              <template #icon>
                <edit-icon />
              </template>
              <template #items>
            ...
            <menu-section label='main-menu.base.configurations'>
              <template #icon>
                <adjustments-icon />
              </template>
              <template #items>
